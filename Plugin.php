...
namespace AnandPatel\SeoExtension;
...
class Plugin extends PluginBase
{
    ...
    public function register()
    {
        ...
        \Event::listen('backend.form.extendFields', function($widget)
        {
            ...
            if(PluginManager::instance()->hasPlugin('Winter.Pages') && $widget->model instanceof \Winter\Pages\Classes\Page)
            {
                $widget->addFields([
                        'viewBag[seo_title]' => [
                        'label'   => 'Meta Title',
            ...
            if(PluginManager::instance()->hasPlugin('Winter.Blog') && $widget->model instanceof \Winter\Blog\Models\Post)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
